...
export const localTaskRecordsRoot = resolve(localHubRoot, 'tasks');
export const agentRoot = resolve(homedir(), '.avicenna-agent');
export const agentProjectRoot = resolve(agentRoot, 'project', repoName);
export const agentProjectStateRoot = resolve(agentProjectRoot, 'state');
export const agentProjectHubRoot = resolve(agentProjectRoot, 'hub');
export const agentProjectDraftRoot = resolve(agentProjectRoot, 'draft');
export const agentProjectTaskRecordsRoot = resolve(agentProjectRoot, 'tasks');
