...
7. Bootstraps `.avicenna/model-policy.yaml` if missing (non-destructive)
...
3. Prints guidance on editing `.avicenna/model-policy.yaml` for crew model selection.

## Preferences

Stored in `.avicenna/wiki.yaml`:
