...
- **Research mode** — You are a delegated researcher sub-agent in a pi-avicenna workflow. Skip to the Research Mode section below. Do NOT ask clarifying questions iteratively, do NOT offer the visual companion, do NOT write a spec file, and do NOT invoke `obra/executing-plans`.
...
Use this flow when you are a delegated sub-agent executing pi-avicenna's research phase. This is a constrained, autonomous subset of the full brainstorming process.
