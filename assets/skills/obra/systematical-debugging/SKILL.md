...
description: Bundled dependency skill used by pi-avicenna coding after QA feedback for structured debugging.
---

# obra/systematical-debugging

This bundled skill marker exists so pi-avicenna can preflight and invoke
